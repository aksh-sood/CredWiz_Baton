              ...
              >
                <div>
                  <TextField
                    ...
                    error={
                      sendmoneyFormik.touched.amount &&
                      Boolean(sendmoneyFormik.errors.amount)
                    }
                    helperText={
                      sendmoneyFormik.touched.amount
                        ? sendmoneyFormik.errors.amount
                        : ""
                    }
                    InputProps={{
                ...
                <div>
                  <TextField
                    ...
                    error={
                      sendmoneyFormik.touched.receiverContactNumber &&
                      Boolean(sendmoneyFormik.errors.receiverContactNumber)
                    }
                    helperText={
                      sendmoneyFormik.touched.receiverContactNumber
                        ? sendmoneyFormik.errors.receiverContactNumber
                        : ""
                    }
                    InputProps={{
                      startAdornment: (
